        ...
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
            ...
            <main class="p-8 space-y-6">
                <div class="flex justify-between items-center">
                    ...
                    <button class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-all">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr v-for="art in articles" :key="art.id" class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-slate-500">{{ art.status }}</td>
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-3">
                                        <button class="text-blue-500 hover:text-blue-700"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></button>
