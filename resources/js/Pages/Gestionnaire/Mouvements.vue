                ...
                <div class="bg-white rounded-xl shadow-md border border-slate-100 overflow-hidden">
                    ...
                    <div v-if="props.stockMovements.links && props.stockMovements.links.length > 3"
                        ...
                        <div class="flex items-center gap-2">
                            <Link preserve-scroll v-for="(link, k) in props.stockMovements.links" :key="k" :href="link.url || '#'"
                                v-html="link.label"
                ...
                <div v-show="activeTab === 'entrepots'" class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-slate-50/50 border-t border-slate-100 flex flex-col items-center gap-2">
                        <div class="flex items-center gap-1">
                            <Link preserve-scroll v-for="(link, k) in (props.warehouses_paginated?.links ?? [])" :key="k" :href="link.url || '#'" v-html="link.label"
