        ...
        <div class="ml-52">
            <header class="bg-white/70 backdrop-blur-md border-b border-slate-200/60 sticky top-0 z-10 shadow-sm">
                <div class="px-8 py-4 flex items-center justify-between">
                    ...
                    <Link :href="route('profile.edit')" class="flex items-center gap-2 text-slate-700 hover:text-teal-600 cursor-pointer group">
                        <span class="text-sm font-medium">{{ $page.props.auth.user.first_name }} {{ $page.props.auth.user.last_name }}</span>
