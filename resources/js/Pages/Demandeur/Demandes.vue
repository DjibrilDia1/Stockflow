            ...
            <main class="p-10 space-y-8">
                ...
                <section class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                    ...
                    <div v-if="showModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <div
                            class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
                            <div
                            ...
                            <form @submit.prevent="submitRequest" class="p-6 space-y-5">
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">Article
                                        demandé</label>
                                    ...
                                    <div v-if="form.errors.article_id" class="text-red-500 text-xs mt-1">{{
                                        form.errors.article_id }}</div>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">Motif de la
                                        demande</label>
                    ...
                    <table class="w-full">
                        <thead class="bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold uppercase text-slate-600">Statut
                                </th>
                            </tr>
                        </thead>
