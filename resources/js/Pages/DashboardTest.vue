...
<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-teal-50/40">
        <aside
            class="fixed left-0 top-0 h-screen w-52 bg-gradient-to-b from-slate-800 to-slate-900 shadow-2xl border-r border-slate-700/50 z-50">
        ...
        <div class="ml-52">
            <header class="bg-white/70 backdrop-blur-md border-b border-slate-200/60 sticky top-0 z-10 shadow-sm">
                <div class="px-8 py-4 flex items-center justify-between">
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input v-model="searchQuery" type="text" placeholder="Rechercher des produits , mouvements...."
            ...
            <main class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="card-hover bg-white rounded-xl p-6 shadow-md border border-slate-100 animate-fade-in"
                        ...
                        <div class="flex items-end justify-between">
                            <div>
                                ...
                                <span class="px-2 py-1 text-xs font-medium text-red-600 bg-red-50 rounded-md">En
                                    rupture</span>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                    ...
                    <div class="bg-white rounded-xl shadow-md border border-slate-100 overflow-hidden flex flex-col">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute inset-0 flex justify-between pointer-events-none"
                                    ...
                                    <div v-for="i in 6" :key="i"
                                        class="h-full border-l border-slate-200 w-full last:border-r"></div>
                                </div>

                                <div class="relative z-10">
                                    <div v-for="article in topArticles" :key="article.name"
                                        class="flex items-center group border-b border-slate-50 last:border-0">
                        ...
                        <div class="p-4 mt-auto flex justify-end">
                            <button
                                class="px-6 py-2 bg-teal-700 hover:bg-teal-800 text-white text-sm font-semibold rounded-lg transition-colors">
                                Voir rapports
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-slate-50 border-b">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">Date
                                    </th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">
                                        Article</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">Type
                                    </th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">
                                        Quantité</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <tr v-for="m in recentMovements" :key="m.id"
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            :class="['px-3 py-1 rounded-md text-xs font-semibold', getMovementTypeClass(m.type)]">
                                            {{ m.type }}
                                        </span>
                                    </td>
                                    <td
                                        :class="['px-6 py-4 text-sm font-bold', m.quantity < 0 ? 'text-red-600' : 'text-teal-600']">
