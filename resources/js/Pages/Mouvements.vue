...
<template>
    ...
    <input type="date" class="bg-transparent border-none text-sm text-slate-500 focus:ring-0 outline-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <button class="flex items-center justify-center gap-2 p-3 bg-teal-50 text-teal-700 rounded-lg font-semibold hover:bg-teal-100 transition-colors border border-teal-100">
                        <span class="text-xl">+</span> Entrée
                    </button>
                    <button class="flex items-center justify-center gap-2 p-3 bg-red-50 text-red-700 rounded-lg font-semibold hover:bg-red-100 transition-colors border border-red-100">
                        <span class="text-xl">-</span> Sortie
                    </button>
                    <button class="flex items-center justify-center gap-2 p-3 bg-orange-50 text-orange-700 rounded-lg font-semibold hover:bg-orange-100 transition-colors border border-orange-100">
                        <span class="text-sm">⚠️</span> Ajustement
                    </button>
                    <button class="flex items-center justify-center gap-2 p-3 bg-blue-50 text-blue-700 rounded-lg font-semibold hover:bg-blue-100 transition-colors border border-blue-100">
