...
>
    ...
    <div class="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" @click="showAddUserModal = false"></div>

    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
            <h3 class="text-lg font-bold text-slate-800">Nouvel Utilisateur</h3>
            <button @click="showAddUserModal = false" class="text-slate-400 hover:text-slate-600 text-2xl">&times;</button>
        </div>
        ...
        <form @submit.prevent="saveUser" class="p-6 space-y-4">
            ...
            <div>
                ...
                <input v-model="newUser.email" type="email" placeholder="m.ndiaye@stockflow.sn" required 
                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select v-model="newUser.role" class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none">
                ...
                <div>
                    ...
                    <select v-model="newUser.statut" class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none">
